...
import { useGetAllPartner } from "../../shared/services/hooks/usePartner";
...
export default function Partners() {
  ...
  const partners = useGetAllPartner();
  ...
  useEffect(() => {
    if (partners.data) setPartnersFiltered(partners.data.value);
  }, [partners.data]);
  ...
  const handleClickButtonFilter = (data: IFormSearch) => {
    const Filtered = partners?.data?.value.filter(
      (partner) =>
